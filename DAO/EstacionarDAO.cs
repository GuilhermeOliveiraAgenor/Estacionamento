    ...
    public class EstacionarDAO
    {
        ...
        public bool Entrada(Estacionar estacionar)
        {
            ...
            try
            {
                ...
                cmdo.Parameters.Add("@horarioEntrada", SqlDbType.DateTime).Value = estacionar.horarioEntrada;
        ...
        public bool Saida(Estacionar estacionar, Pagamento pagamento)
        {
            ...
            try
            {
                ...
                cmdo.CommandType = CommandType.StoredProcedure;
                cmdo.Parameters.Add("@horarioSaida", SqlDbType.DateTime).Value = estacionar.horarioSaida;//parametros
        ...
        public DataTable carregarVeiculo()
        {
            ...
            try
            {
                ...
                cmdo.CommandText = "select Estacionar.idEstacionar, Cliente.Nome, Cliente.Cpf, Veiculo.descricaoVeiculo,clienteVeiculo.Placa,Estacionar.horarioEntrada, Estacionar.Preco, Estacionar.Patio, Estacionar.Status from Estacionar inner join clienteVeiculo on clienteVeiculo.IdClienteVeiculo = Estacionar.CodigoClienteVeiculo inner join Cliente on Cliente.idCliente = clienteVeiculo.codigo_Cliente inner join Veiculo on Veiculo.idVeiculo = clienteVeiculo.codigo_Veiculo where Estacionar.Status = 'Ocupado'";
        ...
        public DataTable PesqCpfOcupados(string cpf)
        {
            ...
            try
            {
                ...
                SqlDataReader dr = cmdo.ExecuteReader();//reebe o resultado
                dt.Load(dr);//carrega o dt
